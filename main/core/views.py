...
class HomeView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        paginator = Paginator(patient_filter.qs, 25)  # Show 10 patients per page
    ...
    def render_to_response(self, context, **response_kwargs):
        ...
        if self.request.htmx:
            return self.render_to_string('patients/patients_list.html', context, **response_kwargs)
...
class StaffRegisterView(CreateView):
    ...
    def get_success_url(self):
        return reverse_lazy('staff-detail', kwargs={'id': self.object.id})
